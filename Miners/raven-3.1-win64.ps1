...
$Path = ".\Bin\NVIDIA-raven-3.1-win64\ccminer.exe"
$Uri = "https://github.com/RavencoinProject/RavencoinMiner/releases/download/v3.1-cu92/Ravencoin.Miner.v3.1.win64.cu92.zip"
...
$Commands = [PSCustomObject]@{
    ...
    "x16r" = " -d $SelGPUCC -N 600" #X16r(fastest open source miner)
