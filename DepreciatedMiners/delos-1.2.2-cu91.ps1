...
$Path = ".\Bin\NVIDIA-delos-1.2.2-cu91\ccminer.exe"
$Uri = "https://github.com/All-in-Miner/miner-binaries/releases/download/delos122-x86-cu91/DelosMiner1.2.2-x86-cu91.zip"
