...
$NMIcon = New-Object system.drawing.icon (".\Assets\All-in-Miner.ico")
$MainForm.Icon = $NMIcon
$MainForm.ClientSize = '740,460' # best to keep under 800,600
$MainForm.text = "Form"
...
$MainForm.add_Shown( {
        ...
        If ($Version.Product -eq $Variables.CurrentProduct -and $version.Version -gt $Variables.CurrentVersion -and $Version.Update) {
            Update-Status("Version $($version.Version) available. (You are running $Variables.CurrentVersion)")
            $LabelNewVersion.ForeColor = "Green"
            $LabelNewVersion.Text = "Version $($version.Version) is available!"
        }
...
$Variables | Add-Member -Force @{CurrentVersion = "2018.06"}
...
#$LabelExcludeMiners = New-Object system.Windows.Forms.Label
#$LabelExcludeMiners.text = "Exclude Miners"
#$LabelExcludeMiners.AutoSize = $false
#$LabelExcludeMiners.width = 120
#$LabelExcludeMiners.height = 20
#$LabelExcludeMiners.location = New-Object System.Drawing.Point(2, 292)
#$LabelExcludeMiners.Font = 'Microsoft Sans Serif,10'
#$ConfigPageControls += $LabelExcludeMiners

#$TBExcludeMiners = New-Object system.Windows.Forms.TextBox
#$TBExcludeMiners.Tag = "ExcludeMiners"
#$TBExcludeMiners.MultiLine = $False
## $TBActiveMinerGainPct.Scrollbars              = "Vertical" 
#$TBExcludeMiners.text = $Config.ExcludeMiners -Join ","
#$TBExcludeMiners.AutoSize = $false
#$TBExcludeMiners.width = 300
#$TBExcludeMiners.height = 20
#$TBExcludeMiners.location = New-Object System.Drawing.Point(122, 292)
#$TBExcludeMiners.Font = 'Microsoft Sans Serif,10'
#$ConfigPageControls += $TBExcludeMiners
...
$ButtonLoadDefaultPoolsAlgos.Add_Click( {
        try {
			...
			$PoolsAlgos = Get-content ".\Config\PoolsAlgos.json" | Convertfrom-json
		}
        If ($PoolsAlgos) {
...
$ButtonWriteConfig.Add_Click( {
        ...
        #$ConfigPageControls | ? {(($_.gettype()).Name -eq "TextBox") -and ($_.Tag -eq "ExcludeMiners")} | foreach {
        #    $Config | Add-Member -Force @{$_.Tag = @($_.Text -split ",")}
        #}
